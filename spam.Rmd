...
library(naivebayes)
set.seed(123)
nb <- naive_bayes(y~., data.frame(X.train, y=as.factor(y.train)), usepoisson = TRUE)
nb.trans <- naive_bayes(y~., data.frame(X.train.trans, y=as.factor(y.train)), usepoisson = TRUE)
nb.reduced <- naive_bayes(y~., data.frame(X.train[,feat.nzeros], y=as.factor(y.train)), usepoisson = TRUE)
nb.trans.reduced <- naive_bayes(y~., data.frame(X.train.trans[,feat.nzeros], y=as.factor(y.train)), usepoisson = TRUE)
summary(nb)
rbind(
calculate_metrics_nb(predict(nb, X.test, type="class"),y.test),
calculate_metrics_nb(predict(nb.trans, X.test.trans, type="class"),y.test),
calculate_metrics_nb(predict(nb, X.test[,feat.nzeros], type="class"),y.test),
calculate_metrics_nb(predict(nb.trans, X.test.trans[,feat.nzeros], type="class"),y.test)
)
```
